        ...
        if (t.NameClass != 0) {
            ...
            items +=
                ...
                <div class="class_banner_information">
                    ...
                    <p>Số học sinh: ${t.AmountStudent}</p>
                </div>
            </div>`
        }
    })
...
function AddClass() {
    ...
    vam('#add_class').onclick = () => {
        ...
        var url = 'https://script.google.com/macros/s/AKfycbyiBR935ia9bcXA2tT3A2l36TAzh8CAchahBNhbWhHwFIq6NB1ygyXSan9vXVRtDBtlpQ/exec' + "?" + `name=${nameclass}&address=${address}&gvcn=${gvcn}&action=addClass`;
        fetch(url, {
            method: 'GET'
